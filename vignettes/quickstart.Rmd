...
To learn more about chatting with a chat client, see the [`ellmer` package](https://ellmer.tidyverse.org/index.html).

## See models

Information about Poppy models that you can use are stored in the [`poppy_models`](https://lucy-dwr.github.io/poppychat/reference/poppy_models.html) object in this package (or run `?poppy_models` from R for the help page).
